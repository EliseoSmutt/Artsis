...
public partial class AbonadosConReservas : ContentPage
{
    public AbonadosConReservas()
    {
        InitializeComponent();
        CargarHTML();
    ...
    private async void CargarHTML()
    {
        ...
        using var stream = assembly.GetManifestResourceStream("Artsis.Metricas.Html.Abonados.GraficoAbonadosConReservas.html");
